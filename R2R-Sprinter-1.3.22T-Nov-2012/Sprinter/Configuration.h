...
#define _AXIS_STEP_PER_UNIT {80.74, 80.96, 4040, 1254}
...
#define _HOMING_FEEDRATE {3000, 3000,1300}      // (mm/min) !!
...
#define _DEF_CHAR_UUID "R2R-Sprin-nov-2012-0000-00000000000"
...
//-- By Obijuan:
//-- Default values:    kp = 2560, ki = 64, kd = 4096
//-- Autotuning 1 for R2-Reloaded: kp = 3666, ki = 62, kd = 13432
//-- Autotuning 2 for R2-Reloaded: kp = 3471, ki = 56, kd = 13373
//-- Autonuning 3 for R2-Reloaded: kp = 2777, ki = 45, kd = 10699

#define PID_PGAIN 2777 //256 is 1.0  // value of X means that error of 1 degree is changing PWM duty by X, probably no need to go over 25

#define PID_IGAIN 45 //256 is 1.0  // value of X (e.g 0.25) means that each degree error over 1 sec (2 measurements) changes duty cycle by 2X (=0.5) units (verify?)

#define PID_DGAIN 10699 //256 is 1.0  // value of X means that around reached setpoint, each degree change over one measurement (half second) adjusts PWM by X units to compensate
