...
// EPCOS 100K Thermistor (B57560G1104F) vendido por reclone3D
//http://shop.reclone3d.com/es/plataforma-caliente/107-termistor-ntc-100k-2-unidades.html
...
const short temptable_90[][2] PROGMEM = {
   {1*OVERSAMPLENR, 821},
   {54*OVERSAMPLENR, 252},
   {107*OVERSAMPLENR, 207},
   {160*OVERSAMPLENR, 182},
   {213*OVERSAMPLENR, 165},
   {266*OVERSAMPLENR, 152},
   {319*OVERSAMPLENR, 141},
   {372*OVERSAMPLENR, 131},
   {425*OVERSAMPLENR, 123},
   {478*OVERSAMPLENR, 115},
   {531*OVERSAMPLENR, 107},
   {584*OVERSAMPLENR, 100},
   {637*OVERSAMPLENR, 93},
   {690*OVERSAMPLENR, 86},
   {743*OVERSAMPLENR, 78},
   {796*OVERSAMPLENR, 70},
