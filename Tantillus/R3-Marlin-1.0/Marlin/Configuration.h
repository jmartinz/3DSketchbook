...
#define STRING_CONFIG_H_AUTHOR "jmartinz" //Who made the changes.
...
#define BED_MINTEMP 0  // Para preubas sin hotbed
...
#define DEFAULT_MAX_FEEDRATE          {330, 330, 2, 45}    // (mm/sec)    
#define DEFAULT_MAX_ACCELERATION      {3000,3000,10,3000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
