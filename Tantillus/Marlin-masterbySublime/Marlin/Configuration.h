...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {122.5,122.5,3200,450}//extruder default steps for herringbone 3.3:1 (450), normal 2.7:1 (320)
// http://forums.reprap.org/read.php?279,138415,page=2 "If using m6 threaded rod for Z the steps per mm are 3200"
