...
//float axis_steps_per_unit[] = {80, 80, 2560,777.6}; JMMP
float axis_steps_per_unit[] = {80, 80, 4000,1091}; //JMMP segn instrucciones en http://www.2engineers.com/shop/geared150/ y Z con varilla 5M
...
//const int Z_MAX_LENGTH = 100; JMMP
const int Z_MAX_LENGTH = 200; //JMMP Prusa i3!!!

//// MOVEMENT SETTINGS
const int NUM_AXIS = 4; // The axis order in all axis related arrays is X, Y, Z, E
//float max_feedrate[] = {200000, 200000, 240, 500000};
float max_feedrate[] = {200000, 200000, 140, 500000}; // JMMP varillas 5mm
